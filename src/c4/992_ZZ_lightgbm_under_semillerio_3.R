...
PARAM <- list()
PARAM$experimento <- "ZZ4001_semillerio_m1"
...
PARAM$semillerio <- 15 # ¿De cuanto será nuestro semillerio?
PARAM$indice_inicio_semilla <- 1
PARAM$indice_fin_semilla <- 15
...
# IMPUTO CON NA LA CLASE DEL DATASET FUTURE!

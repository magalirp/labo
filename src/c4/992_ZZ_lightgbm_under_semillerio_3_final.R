...
PARAM <- list()
PARAM$experimento <- "ZZ4003_semillerio_m2_final"
PARAM$exp_input <- "HT4003"
PARAM$exp_input_future <- "FE4003"
...
#cargo el dataset donde esta septiembre (donde voy a aplicar el modelo final)
dataset_input  <- paste0( "./exp/", exp_input_future, "/dataset1.csv.gz" )
dfuture  <- fread( dataset_input )

#me quedo solo con septiembre (dfuturo)
dfuture[ foto_mes==202109, ]

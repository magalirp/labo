...
PARAM  <- list()
PARAM$experimento <- "TS4001"

PARAM$exp_input  <- "FE4001"

PARAM$future       <- c( 202107 )

PARAM$future_final <- c( 202109 )

PARAM$final_train  <- c( 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 
                         202011, 202012, 202101, 202102, 202103, 202104)

PARAM$train$training     <- c( 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905,  
                               202011, 202012, 202101, 202102, 202103, 202104)
...
dataset_input  <- paste0( "./exp/", PARAM$exp_input, "/dataset1.csv.gz" )
...
#grabo los datos del futuro (final)
# aqui JAMAS se hace sampling
fwrite( dataset[ foto_mes %in% PARAM$future_final, ],
        file= "dataset_future_final.csv.gz",
        logical01= TRUE,
        sep= "," )

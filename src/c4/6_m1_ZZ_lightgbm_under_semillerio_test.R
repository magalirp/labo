...
# SEMILLERO DEL IMPRESCINDIBLE TOMAS DELVECHIO
...
PARAM <- list()
PARAM$experimento <- "ZZ4001_semillerio_m3"
...
PARAM$semillerio <- 20 # ¿De cuanto será nuestro semillerio?
...
# IMPUTO CON NA LA CLASE DEL DATASET FUTURE (JULIO)!
dfuture[ foto_mes==202107,  clase_ternaria  := NA ]

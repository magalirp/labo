...
setwd("/Users/magal/OneDrive/Escritorio/EYF_22")  #establezco la carpeta donde voy a trabajar
#cargo el dataset
...
vi <- data.frame(modelo_pruned$variable.importance)
...
fwrite( entrega, paste0( "./exp/stopping_at_canaritos_fe.csv"), sep="," )
